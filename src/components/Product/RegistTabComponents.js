    ...
    return (
        <Box>
            ...
            >
                ...
                >   
                    ...
                    >
                        ...
                        <Typography fontSize={'13px'} sx={{color: '#9B99A9'}}>이미지 등록</Typography>
                    </Box>
                </label>
                <Typography sx={{display: 'flex', alignItems: 'center', color: '#9B99A9', marginLeft: '15px'}}>
            ...
            <ImageList sx={{ width: 840}} cols={4} rowHeight={220} >
                {props.imgFiles.map((img) => (
                    <ImageListItem key={img.url}>
                        <img
                            src={img.url} style={{ width: '200px', objectFit: 'contain', border: '1px solid #E6E5EF', backgroundColor: '#FAFAFD'}}
                        />
            ...
            <ul style={{ listStyle: 'none', color: '#4AA4FF', fontSize: '14px'}}>
                ...
                <li>- 이미지를 가급적 권장 사이즈(640x640)로 맞춰서 업로드 해주세요.</li>
                <li>- 권장 사이즈(640x640)을 넘어가는 이미지는 자동으로 리사이징 됩니다.</li> 
            </ul>
        </Box>
    );
    ...
    return (
        <Box>
            ...
            >
                ...
                />
                <Typography sx={{display: 'flex', justifyContent: 'end', marginRight: '20px', marginTop: '10px'}}>{descriptionLen} / 2000</Typography>
            </Box>
...
export {ProductCategory, ProductDescription, ProductImg, ProductName, ProductPrice};